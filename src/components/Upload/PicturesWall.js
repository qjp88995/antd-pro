...
const uploadAddr = `${uploadHost}/file/upload/image`;
const uploadName = 'file';

export default class PicturesWall extends FileList {
    render() {
        ...
        return (
            ...
            fileList.map((item, index) => (
                <div key={`item${index+1}`} className={styles.card}>
